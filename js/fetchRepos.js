...
request.onload = function () {
  ...
  if (request.status >= 200 && request.status < 400) {
    ...
    data.forEach((repo) => {
      ...
      const bottomRhsASvg = document.createElementNS(
      ...
      const bottomRhsASvgSvg = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "path"
      ); //Create a path in SVG's namespace
      bottomRhsASvgSvg.setAttribute(
        "d",
      ...
      const buttonLhsSpanSvg = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "svg"
      );
      ...
      const buttonLhsSpanSvgSvg = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "path"
      ); //Create a path in SVG's namespace
      buttonLhsSpanSvgSvg.setAttribute(
        "d",
      ...
      const buttonMitSpanSvg = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "svg"
      );
      ...
      const buttonMitSpanSvgSvg = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "path"
      ); //Create a path in SVG's namespace
      buttonMitSpanSvgSvg.setAttribute(
        "d",
      ...
      bottomLastP.textContent = `Updated on ${month_name(
